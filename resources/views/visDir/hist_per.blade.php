	...
	<div class="col s8">
		...
		<div class="row">
			<div class="input-field col s4">
				<a href="/segpub/barandilla/historialD" class="waves-effect waves-light btn"><i class="fa fa-arrow-left" aria-hidden="true"></i>Regresar</a>
			</div>
		</div>
	</div>
	...
	<div class="col s4 card-panel amber lighten-5">
		...
		@foreach ($detenciones as $detencion)
			<tr>
				...
				<td>
					<a href="/segpub/personas/detencionD/{{$detencion->id}}" class="waves-effect waves-light btn">Ver</a>
				</td>
			</tr>
		@endforeach
		</tbody>
